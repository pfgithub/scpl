...
ParserHelper_js_1.o.filter = ParserHelper_js_1.p(ParserHelper_js_1.c `:filter{`, _n, ParserHelper_js_1.star(ParserHelper_js_1.p(_n, ParserHelper_js_1.o.filteritem, _n, ParserHelper_js_1.c `&`, _n).scb(([, item]) => item)), ParserHelper_js_1.o.filteritem, _n, ParserHelper_js_1.c `}`).scb(([, , filterItems, lastFilterItem], start, end) => new ParserData_js_1.FilterParse(start, end, [...filterItems, lastFilterItem]));
