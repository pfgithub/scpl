...
ParserHelper_js_1.o.identifier = ParserHelper_js_1.regex(/^[A-Za-z@_][A-Za-z0-9@_]*/).scb(([fullmatch], start, end) => new ParserData_js_1.IdentifierParse(start, end, fullmatch));
...
ParserHelper_js_1.o.inputarg = ParserHelper_js_1.p(ParserHelper_js_1.c `^`, _, ParserHelper_js_1.or(ParserHelper_js_1.o.parenthesis, ParserHelper_js_1.o.variable), _).scb(([, , paren]) => {
...
ParserHelper_js_1.o.onlyaction = ParserHelper_js_1.p(ParserHelper_js_1.o.identifier, _, ParserHelper_js_1.o.args).scb(([actionIdentifier, _, args], start, end) => {
    const flags = [];
    args = args.filter((arg) => arg && arg instanceof ParserData_js_1.VariableFlagParse
...
ParserHelper_js_1.o.filter = ParserHelper_js_1.or(ParserHelper_js_1.o.filterand, ParserHelper_js_1.o.filteror);
ParserHelper_js_1.o.filterand = ParserHelper_js_1.p(ParserHelper_js_1.c `:filter{`, _n, ParserHelper_js_1.star(ParserHelper_js_1.p(_n, ParserHelper_js_1.o.filteritem, _n, ParserHelper_js_1.or(ParserHelper_js_1.c `&`, ParserHelper_js_1.c `:and:`), _n).scb(([, item]) => item)), ParserHelper_js_1.o.filteritem, _n, ParserHelper_js_1.c `}`).scb(([, , filterItems, lastFilterItem], start, end) => new ParserData_js_1.FilterParse(start, end, "and", [...filterItems, lastFilterItem]));
ParserHelper_js_1.o.filteror = ParserHelper_js_1.p(ParserHelper_js_1.c `:filter{`, _n, ParserHelper_js_1.star(ParserHelper_js_1.p(_n, ParserHelper_js_1.o.filteritem, _n, ParserHelper_js_1.or(ParserHelper_js_1.c `|`, ParserHelper_js_1.c `:or:`), _n).scb(([, item]) => item)), ParserHelper_js_1.o.filteritem, _n, ParserHelper_js_1.c `}`).scb(([, , filterItems, lastFilterItem], start, end) => new ParserData_js_1.FilterParse(start, end, "or", [...filterItems, lastFilterItem]));
